                          ...
                          <div class="profile-header">
                             ...
                             <div class="user-detail text-center mb-3">
                                <div class="profile-img">
                                   <img src="{{ Auth::user()->randomAvatar }}" alt="profile-img" class="avatar-130 img-fluid" />
                                </div>
                                @php
                                    $hour = session('login_time') ? session('login_time')->format('H') : now()->format('H');
                                ...
                                @endphp
                                    ...
                                    <div class="profile-detail">
                                        <a href = "{{ route('profile', Auth::user()->username) }} ">
                                            <h3 class=""><span style="font-size:large" >{{ $greeting }},</span> {{ ucfirst(Auth::user()->username )}} </h3>
                                        </a>
                                    </div>
                             </div>
                                ...
                                <div class="social-info">
                                   <ul class="social-data-block d-flex align-items-center justify-content-between list-inline p-0 m-0">
                                      ...
                                      <li class="text-center pl-3">
                                        ...
                                        <li class="text-center pl-3">
                                            <h6>Following</h6>
                                            <p class="mb-0">{{ auth()->user()->follows->count() }}</p>
                                        </li>
                                        <li class="text-center pl-3">
                                            <h6>Followers</h6>
                                            <p class="mb-0">{{ auth()->user()->following->count() }}</p>
                                        </li>


                                      {{-- call the totalLikes method to get the total post the user liked --}}
                                        {{-- <p class="mb-0">{{ Auth::user()->totalLikes() }}</p> --}}  {{-- call the totalLikes method to get the total post the user liked --}}
                          ...
                          <div class="iq-card-body p-0">
                             <div class="row">
                                <div class="col-lg-4">
                                   ...
                                   {{-- Create Event component Section --}}
                                    <x-event />
                                   {{-- Create Event Section End --}}
                                   {{-- Photos Component Section --}}
                                    <x-photos />
                                      {{-- Photos Component Section End --}}
                                      {{-- Friends Component Section --}}
                                    <x-friends />
                                      {{-- Friends Component Section End --}}
                                </div>
                                <div class="col-lg-8">
                                    {{-- Post Create Section --}}
                                            @include('posts.create')
                                                {{-- @include('components.post-create-form', ['post' => $post]) --}}
                                   {{-- Post Page Starts --}}
                                   @if($posts->count() == 0)
                                   <div >
                                ...
                                @else
                                   <div class="iq-card">
                                       {{-- Post card component section --}}
                                       @foreach ($posts as  $post)
                                       {{-- past the post to the component --}}
                                       {{-- <x-post-card :post="$post" /> --}}
                                       @include('posts.index', ['post' => $post])
                                       @endforeach
                                       {{ $posts->links() }}
                                        {{-- Post card component section End --}}
                                        @endif
                                    </div>
                                </div>
                             </div>
