<nav class="navbar navbar-expand-lg navbar-light p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
       <ul class="navbar-nav ml-auto navbar-list">
          <li>
             <a href="{{ route('profile', ucfirst(Auth::user()->username)) }}" class="iq-waves-effect d-flex align-items-center">
                <img src="/images/user/1.jpg" class="img-fluid rounded-circle mr-3" alt="user">
                <div class="caption">
                   <h6 class="mb-0 line-height">{{ ucfirst(Auth::user()->name )}}</h6>
                </div>
             </a>
          </li>
          <li>
             <a href="{{ route('index') }}" class="iq-waves-effect d-flex align-items-center">
                ...
                <div class="iq-card shadow-none m-0">
                   <div class="iq-card-body p-0 ">
                      ...
                      <div class="bg-primary p-3 line-height">
                         <h5 class="mb-0 text-white line-height">Hello, {{ ucfirst(Auth::user()->username )}}, {{ $greeting }}</h5>
                      ...
                      <form action="/logout" method="POST" >
                          @csrf
                          <button class="btn btn-primary d-inline-block w-100 text-center p-3">Logout</button>
                      </form>
                   </div>
                </div>
             </div>
