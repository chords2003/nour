...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/users/{user}', [UserProfileController::class, 'show'])->name('users');
    ...
    Route::get('/requests', [GroupController::class, 'pendingRequests'])->middleware(['auth', 'verified'])->name('requests');
    ...
    Route::get('/follows', [FollowController::class, 'index'])->middleware(['auth', 'verified'])->name('follows');
    Route::get('/followers', [FollowersController::class, 'index'])->middleware(['auth', 'verified'])->name('followers');
    Route::post('/toggleFollow/{user}', [FollowController::class, 'store'])->middleware(['auth', 'verified'])->name('follow');
    Route::post('/toggleFollow/{user}', [FollowersController::class, 'store'])->middleware(['auth', 'verified'])->name('followers');
    Route::delete('/unfollow/{user}', [FollowController::class, 'destroy'])->middleware(['auth', 'verified'])->name('unfollow');
